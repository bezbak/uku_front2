...
export default function Avatar({
    ...
    return (
        <div className="gw-avatar">
            <div
                className={CN("gw-avatar__image", {
                    "gw-avatar__image--with-border": border,
                })}
            >
                {placholder && !url ? (
                    <Icon width={placholderSize} height={placholderSize}>
                        <path
                    ...
                    <img src={url} alt="" className="avatar__img" />
                )}
            </div>
            <style jsx>
                {`
