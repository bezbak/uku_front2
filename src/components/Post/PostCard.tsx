            ...
            >
                <div className="post-card__inner">
                    ...
                    <section className={CN("post-card__body")}>
                        ...
                        <div
                            className={CN("post-card__content", {
                                "post-card__content--news":
                                    item.publication_type === "news",
                            })}
                        >
                ...
                <style jsx>{`
                    ...
                    .post-card__content--news .post-card__categories {
                        color: #e8e8e8;
                    }

                    .post-card__content--news .post-card__title {
                        color: #ffffff;
                    }

                    .post-card__content--news .post-card__footer {
                        color: #e6e6e6;
                    }
